...
export class BudgetPlannerComponent implements OnInit {
  ...
  //   if(event.currentTarget.getElementsByClassName('acc2')[0].getAttribute('style') != 'display:block'){
  //     event.currentTarget.getElementsByClassName('acc2')[0].setAttribute('style','display:block');
  //   } else {
  //     event.currentTarget.getElementsByClassName('acc2')[0].setAttribute('style','display:none');
  //   }
  // }
